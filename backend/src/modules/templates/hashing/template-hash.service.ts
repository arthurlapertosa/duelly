...
const binaryMarketTypeCodes: Record<BinaryMarketType, number> = {
  ...
  FOOTBALL_MATCH_TEAM_WIN_YES_NO: 103,
  FOOTBALL_MATCH_DRAW_YES_NO: 104,
...
export function buildCanonicalTemplate(candidate: NormalizedMarketCandidate): CanonicalSportsTemplate {
  ...
  const withoutHash = {
    ...
    ctfOracleAddress: candidate.ctfOracleAddress,
    ctfOracleSource: candidate.ctfOracleSource,
    ctfOracleValidationStatus: candidate.ctfOracleValidationStatus ?? 'missing-input',
    questionIdHash,

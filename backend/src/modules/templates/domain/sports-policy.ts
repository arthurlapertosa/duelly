...
export const DEFAULT_MAX_LIVE_TENNIS_MATCH_START_AGE_HOURS = 4;
export const DEFAULT_MAX_LIVE_TENNIS_MATCH_START_AGE_SECONDS = DEFAULT_MAX_LIVE_TENNIS_MATCH_START_AGE_HOURS * 60 * 60;
